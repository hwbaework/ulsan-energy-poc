...
function ChartTooltip({ active, payload, label }: { active?: boolean; payload?: TooltipEntry[]; label?: string }) {
  ...
  return (
    <div
      className="rounded-lg bg-[#0d1520] ring-1 ring-white/10 px-3 py-2.5 shadow-xl text-xs transition-all duration-300 ease-out"
      style={{
        opacity: visible ? 1 : 0,
...
export function ScrollableChart({
  ...
  return (
    <div className={cn('rounded-xl bg-[#0d1520]', className)}>
      {/* Header */}
      ...
      {/* Chart area */}
      <div ref={chartRef} className="px-2 cursor-grab active:cursor-grabbing" style={{ touchAction: 'none' }}>
